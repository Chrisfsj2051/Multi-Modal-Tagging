...
model = dict(
    ...
    head_config=dict(fusion=dict(
        dict(type='HMCHead',
             label_id_file='dataset/tagging/label_super_id_2130.txt'))))
...
data = dict(
    train=dict(label_id_file='dataset/tagging/label_super_id_2130.txt'),
    val=dict(label_id_file='dataset/tagging/label_super_id_2130.txt'))
