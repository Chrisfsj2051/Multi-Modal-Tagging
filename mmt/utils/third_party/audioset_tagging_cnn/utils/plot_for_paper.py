...
def plot_six_figures(args):
    ...
    # Paths
    class_labels_indices_path = os.path.join('metadata',
...
def plot_complexity_map(args):
    ...
    flops = np.array([
        21.986, 28.166, 42.220, 30.081, 48.962, 54.563, 3.614, 2.810, 30.395,
    ...
    shift = [[-5.5, -0.004], [1, -0.004], [-1, -0.014], [-2, 0.006],
             [-7, 0.006], [1, -0.01], [0.5, 0.004], [-1, -0.014], [1, -0.007],
...
def plot_long_fig(args):
    ...
    audio_clips_per_class = stats['official_balanced_training_samples'] + stats[
    ...
    # PANNs MobileNetV1
    maps_panns_mobilenetv1 = stats['panns_mobilenetv1']['eval'][
        'average_precision']
    maps_panns_mobilenetv1 = maps_panns_mobilenetv1[sorted_indexes]

    # PANNs Wavegram-Logmel-Cnn14
    maps_panns_wavegram_logmel_cnn14 = stats['panns_wavegram_logmel_cnn14'][
        'eval']['average_precision']
    maps_panns_wavegram_logmel_cnn14 = maps_panns_wavegram_logmel_cnn14[
        sorted_indexes]

    # Plot mAPs
    _scatter_4_rows(maps_panns_wavegram_logmel_cnn14,
                    ax1b,
                    ax2b,
                    ax3b,
                    ax4b,
    ...
    linewidth = 0.7
    line0te = _plot_4_rows(maps_panns_wavegram_logmel_cnn14,
                           ax1b,
                           ax2b,
                           ax3b,
                           ax4b,
    ...
    line1te = _plot_4_rows(maps_panns_cnn14,
                           ax1b,
                           ax2b,
                           ax3b,
                           ax4b,
                           ...
                           linewidth=linewidth,
                           label='AP with CNN14')
    line2te = _plot_4_rows(maps_panns_mobilenetv1,
                           ax1b,
                           ax2b,
                           ax3b,
                           ax4b,
    ...
    line3te = _plot_4_rows(maps_avg_instances,
                           ax1b,
                           ax2b,
                           ax3b,
                           ax4b,
    ...
    ax1b.scatter(np.arange(N)[sorted_label_quality == None],
                 0.5 *
                 np.ones(len(np.arange(N)[sorted_label_quality == None])),
                 s=12,
                 c='r',
                 linewidth=0.8,
                 marker='_')
