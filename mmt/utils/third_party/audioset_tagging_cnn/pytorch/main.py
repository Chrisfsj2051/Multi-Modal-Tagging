...
from data_generator import (AlternateTrainSampler, AudioSetDataset,
                            BalancedTrainSampler, EvaluateSampler,
                            TrainSampler, collate_fn)
from evaluate import Evaluator
from losses import get_loss_func
from models import (Cnn6, Cnn10, Cnn14, Cnn14_8k, Cnn14_16k,
                    Cnn14_DecisionLevelAtt, Cnn14_DecisionLevelMax,
                    Cnn14_emb32, Cnn14_emb128, Cnn14_emb512, Cnn14_mel32,
                    Cnn14_mel128, Cnn14_mixup_time_domain, Cnn14_no_dropout,
                    Cnn14_no_specaug, DaiNet19, LeeNet11, LeeNet24,
                    MobileNetV1, MobileNetV2, Res1dNet31, Res1dNet51, ResNet22,
                    ResNet38, ResNet54, Wavegram_Cnn14,
                    Wavegram_Logmel128_Cnn14, Wavegram_Logmel_Cnn14)
from pytorch_utils import (count_flops, count_parameters, do_mixup,
                           move_data_to_device)
from utilities import (Mixup, StatisticsContainer, create_folder,
                       create_logging, get_filename)
...
if __name__ == '__main__':
    ...
    parser_train.add_argument('--loss_type',
                              type=str,
                              default='clip_bce',
                              choices=['clip_bce'])
    parser_train.add_argument('--balanced',
                              type=str,
                              default='balanced',
                              choices=['none', 'balanced', 'alternate'])
    parser_train.add_argument('--augmentation',
                              type=str,
                              default='mixup',
                              choices=['none', 'mixup'])
