...
to process parts of the ranked list. After processing src the parts, we call
...
class AveragePrecisionCalculator(object):
    ...
    def __init__(self, top_n=None):
        """Construct an AveragePrecisionCalculator to calculate average
        precision.
        ...
        Args:
          top_n: A positive Integer specifying the average precision at n, or
            None to use src provided data points.
