...
model = dict(
    ...
    branch_config=dict(image_branch=dict(plugins=[
        dict(cfg=dict(
            type='DropBlock', drop_prob=0.05, block_size=15, postfix='_1'),
             stages=(False, False, True, True),
             position='after_conv1'),
        dict(cfg=dict(
            type='DropBlock', drop_prob=0.05, block_size=15, postfix='_2'),
             stages=(False, False, True, True),
             position='after_conv2'),
        dict(cfg=dict(
            type='DropBlock', drop_prob=0.05, block_size=15, postfix='_3'),
             stages=(False, False, True, True),
