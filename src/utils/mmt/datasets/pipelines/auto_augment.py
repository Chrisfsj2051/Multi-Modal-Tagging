...
class Shear(object):
    ...
    Args:
        ...
        img_fill_val (int | float | tuple): The filled values for image border.
            If float, the same fill value will be used for src the three
    ...
    def __init__(self,
        ...
        assert np.all([0 <= val <= 255 for val in img_fill_val]), 'src ' \
...
class Rotate(object):
    ...
    Args:
        ...
        img_fill_val (int | float | tuple): The fill value for image border.
            If float, the same value will be used for src the three
    ...
    def __init__(self,
        ...
        assert np.all([0 <= val <= 255 for val in img_fill_val]), \
            'src elements of img_fill_val should between range [0,255]. '\
            f'got {img_fill_val}.'
...
class Translate(object):
    ...
    Args:
        ...
        img_fill_val (int | float | tuple): The filled value for image
            border. If float, the same fill value will be used for src
