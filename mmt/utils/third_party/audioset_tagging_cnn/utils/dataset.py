...
import librosa
import numpy as np
from utilities import (create_folder, create_logging, float32_to_int16,
                       get_filename, pad_or_truncate, read_metadata)


def split_unbalanced_csv_to_partial_csvs(args):
    """Split unbalanced csv to part csvs.

    Each part csv contains up to 50000 ids.
    """
...
if __name__ == '__main__':
    ...
    parser_pack_wavs.add_argument(
        ...
        required=True,
        help='Directory to save out downloaded audio.')
    parser_pack_wavs.add_argument('--waveforms_hdf5_path',
                                  type=str,
                                  required=True,
