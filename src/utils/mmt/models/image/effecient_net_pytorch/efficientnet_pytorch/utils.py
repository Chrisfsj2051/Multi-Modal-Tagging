...
# Parameters for the entire model (stem, src blocks, and head)
...
class Conv2dStaticSamePadding(nn.Conv2d):
    ...
    The padding mudule is calculated in construction function, then used in
    forward.
    """
...
def get_model_params(model_name, override_params):
    ...
    if model_name.startswith('efficientnet'):
        ...
        # note: src models have drop connect rate = 0.2
