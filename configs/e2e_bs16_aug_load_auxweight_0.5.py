...
model = dict(
    ...
    head_config=dict(
        image=dict(cls_head_config=dict(loss=dict(loss_weight=0.5))),
        audio=dict(cls_head_config=dict(loss=dict(loss_weight=0.5))),
        video=dict(cls_head_config=dict(loss=dict(loss_weight=0.5))),
        text=dict(cls_head_config=dict(loss=dict(loss_weight=0.5))),
    )
)
