...
def parse_args():
    ...
    parser.add_argument('--branch_1', help='checkpoint file')
    parser.add_argument('--branch_2', help='checkpoint file')
    parser.add_argument('--key_1', help='checkpoint file')
    parser.add_argument('--key_2', help='checkpoint file')
