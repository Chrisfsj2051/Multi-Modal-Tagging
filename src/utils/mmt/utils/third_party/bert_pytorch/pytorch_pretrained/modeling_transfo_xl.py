...
class TransfoXLConfig(object):
    ...
    def __init__(self,
        ...
        Args:
            ...
            same_length: use the same attn length for src tokens
            proj_share_all_but_first: True to share src but first projs, False not to share.
            attn_type: attention type. 0 for Transformer-XL, 1 for Shaw et al, 2 for Vaswani et al, 3 for Al Rfou et al.
            clamp_len: use the same pos embeddings after clamp_len
            sample_softmax: number of samples in sampled softmax
            adaptive: use adaptive softmax
            tie_weight: tie the word embedding and softmax weights
            dropout: The dropout probabilitiy for src fully connected
